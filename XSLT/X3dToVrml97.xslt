...
-->
	  ...
	  <xsl:value-of select="preceding::ExternProtoDeclare[@name=$ProtoName]/field[@name=$fieldName]/@type"/>
        ...
        <xsl:when test="($nodeName='TouchSensor') and ($shortFieldName='isOver')">
          <xsl:text>SFBool</xsl:text>
        </xsl:when>
        <xsl:when test="($nodeName='TouchSensor') and ($shortFieldName='touchTime')">
          <xsl:text>SFTime</xsl:text>
        </xsl:when>
        <xsl:when test="($nodeName='TouchSensor') and (($shortFieldName='hitPoint') or ($shortFieldName='hitNormal'))">
          <xsl:text>SFVec3f</xsl:text>
        </xsl:when>
        <xsl:when test="($nodeName='TouchSensor') and ($shortFieldName='hitTexCoord')">
        ...
        <xsl:when test="($nodeName='Viewpoint') and (($shortFieldName='position') or ($shortFieldName='centerOfRotation'))">
          <xsl:text>SFVec3f</xsl:text>
        </xsl:when>
        <xsl:when test="($nodeName='Viewpoint') and ($shortFieldName='orientation')">
          <xsl:text>SFRotation</xsl:text>
        </xsl:when>
        <xsl:when test="($nodeName='Viewpoint') and ($shortFieldName='description')">
          <xsl:text>SFString</xsl:text>
        </xsl:when>
        <xsl:when test="($nodeName='Viewpoint') and  (($shortFieldName='jump') or ($shortFieldName='bind') or ($shortFieldName='isBound'))">
          <xsl:text>SFBool</xsl:text>
        </xsl:when>
        <xsl:when test="($nodeName='Viewpoint') and  ($shortFieldName='fieldOfView')">
          <xsl:text>SFFloat</xsl:text>
        </xsl:when>
        <xsl:when test="($nodeName='Viewpoint') and  ($shortFieldName='bindTime')">
          <xsl:text>SFTime</xsl:text>
        </xsl:when>
        ...
        <xsl:when test="($nodeName='ProximitySensor') and (($shortFieldName='centerOfRotation') or ($shortFieldName='position'))">
          <xsl:text>SFVec3f</xsl:text>
        </xsl:when>
        <xsl:when test="($nodeName='ProximitySensor') and (($shortFieldName='orientation'))">
          <xsl:text>SFRotation</xsl:text>
        </xsl:when>
        <xsl:when test="(($nodeName='ProximitySensor') or ($nodeName='VisibilitySensor')) and (($shortFieldName='center') or ($shortFieldName='size'))">
          <xsl:text>SFVec3f</xsl:text>
        </xsl:when>
        <xsl:when test="(($nodeName='ProximitySensor') or ($nodeName='VisibilitySensor')) and (($shortFieldName='enterTime') or ($shortFieldName='exitTime'))">
          <xsl:text>SFTime</xsl:text>
        </xsl:when>
        ...
        <xsl:when test="(($nodeName='ElevationGrid') or ($nodeName='Extrusion') or ($nodeName='IndexedFaceSet')) and (($shortFieldName='ccw') or ($shortFieldName='solid') or ($shortFieldName='colorPerVertex') or ($shortFieldName='normalPerVertex'))">
          <xsl:text>SFBool</xsl:text>
        </xsl:when>
        <xsl:when test="(($nodeName='ElevationGrid') or ($nodeName='Extrusion') or ($nodeName='IndexedFaceSet')) and ($shortFieldName='creaseAngle')">
          <xsl:text>SFFloat</xsl:text>
        </xsl:when>
        <xsl:when test="($nodeName='ElevationGrid') and (($shortFieldName='xDimension') or ($shortFieldName='zDimension'))">
          <xsl:text>SFInt32</xsl:text>
        </xsl:when>
        <xsl:when test="($nodeName='ElevationGrid') and (($shortFieldName='xSpacing') or ($shortFieldName='zSpacing'))">
          <xsl:text>SFFloat</xsl:text>
        </xsl:when>
