...
<!--
  <head>
   ...
   <meta name="url"         content="http://www.web3d.org/TaskGroups/x3d/content/X3dToXhtml-2.xslt" />
  </head>
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:saxon="http://icl.com/saxon" saxon:trace="no">
	...
	<xsl:template match="/">
		<html>
			<head>
				...
				<meta name="generator" content="http://www.web3D.org/TaskGroups/x3d/content/X3dToXhtml-2.xslt"></meta>
			</head>
			<body>
	...
	<xsl:template match="*" >
		...
		<xsl:if test="local-name()='NavigationInfo'">
			<center>
				<xsl:text> hello NavigationInfo! </xsl:text>
				<xsl:message> NavigationInfo node message. </xsl:message>
				<xsl:comment> NavigationInfo node comment. </xsl:comment>
